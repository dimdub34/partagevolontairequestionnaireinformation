...
from partagevolontairequestionnaireinformationGui import DConfigure
...
class Serveur(object):
    def __init__(self, le2mserv):
        ...
        actions[le2mtrans(u"Display payoffs")] = \
            ...
            display_payoffs_onserver("partagevolontairequestionnaireinformation")
    ...
    def _demarrer(self):
        ...
        if not self._le2mserv.gestionnaire_graphique.question(
                        le2mtrans(u"Start") + u" partagevolontairequestionnaireinformation?"):
            return
